/*:
 ...
 É um *creational design pattern* que nos permite criar objetos de uma superclasse, mas que também permite que subclasses alterem o tipo desses objetos criado.
...
/// The client code works with an instance of a concrete creator (neste caso,
/// passada por parâmetro), albeit through its base protocol. As long as the
/// client keeps working with the creator via the base protocol, you can pass
...
let test = FactoryMethodConceptual()
test.testFactoryMethodConceptual()
//: [Next](@next)
